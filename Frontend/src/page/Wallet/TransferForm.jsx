...
const TransferForm = () => {
  ...
  const handleSubmit = () => {
    dispatch(transferMoney({jwt: localStorage.getItem("jwt"),
  ...
  return (
    <div className='pt-10 space-y-5'>
      ...
      <div>
        ...
        <Input name="amount" onChange={handleChange} value={formData.amount} className="py-7" placeholder="$1000" />
      </div>

      <div>
        <h1 className='pb-1'>Wallet ID</h1>
        <Input name="walletId" onChange={handleChange} value={formData.walletId} className="py-7" placeholder="#ADFG465" />
      </div>
